...
public class Customer implements Serializable, Comparable {
    ...
    public void setHomeAddress(Address homeAddress)  {
    	Customer cust = homeAddress.getCustomer();
    	 if(cust != null){
    		 System.out.println("Adress already being refered by "+cust);
    		 throw new RuntimeException("Address is already being refrrred");
    	 }else{
    		   this.homeAddress = homeAddress;
    		   homeAddress.setCustomer(this);
    	 }
