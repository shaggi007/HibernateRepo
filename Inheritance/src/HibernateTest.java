...
above structure is not normalized where we have so many null values
...
if you don't prvoide the value of steeringhandle/steeringwheel ,using this discriminator we can identiy implementation.
*/